              ...
              model=dict(
                  ...
                  perceiver_kwargs=dict(
                      embedding_config=dict(
                          num_fourier_channels=16,  # TODO-a ,12
                          num_categorical_channels=20,  #TODO-b ,15
                          question_name_embedding_size=6, #TODO-c ,4
                      ),
                      encoder_config=dict(
                          num_self_attends_per_block=_default_or_debug(6, 2), #TODO-d ,8
                          # Weights won't be shared if num_blocks is set to 1.
                          num_blocks=_default_or_debug(8, 2),
                          z_index_dim=512,
                          num_z_channels=1024,
                          num_cross_attend_heads=2, #TODO -e ,1 
                          num_self_attend_heads=8, #TODO -f ,4
                          cross_attend_widening_factor=1,
                          self_attend_widening_factor=1,
                          dropout_prob=0.1, #TODO -g ,0.1
