              ...
              model=dict(
                  ...
                  perceiver_kwargs=dict(
                      embedding_config=dict(
                          num_fourier_channels=8,  # TODO-a ,4
                          num_categorical_channels=11,  #TODO-b ,6
                          question_name_embedding_size=2, #TODO-c ,4
                      ),
                      encoder_config=dict(
                          num_self_attends_per_block=_default_or_debug(6, 2), #TODO-d m3
                          # Weights won't be shared if num_blocks is set to 1.
                          num_blocks=_default_or_debug(4, 2), # TODO-e ,4
                          z_index_dim=512, # TODO-f ,256
                          num_z_channels=1024, #TODO-g ,512
                          num_cross_attend_heads=1,
                          num_self_attend_heads=8, #TODO-h ,4
